...
from .processors import ReferenceProcessor, SecureDataProcessor, ExtraFieldsProcessor
from .wrapper import CustomAsyncBoundLogger
...
def configure_logger(enable_json_logs: Optional[bool] = None, debug: Optional[bool] = None,
    ...
    shared_processors: List[Processor] = [
        ...
        processors.TimeStamper(fmt="iso"),  # Добавление временной метки
